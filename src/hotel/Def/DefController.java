...
public class DefController implements Initializable {
    ...
    public void checkInRoom() {
        ...
        try {
            ...
            preparedRoom.setString(1, Default1.getText());
            ...
            if (buttonCheck1.getText().equals("Check in") && user.getMoney() > 0) {
                if (user.getIdRoom() == null && parseInt(resultRoom.getString(5)) < 2) {
                    ...
                    if (users == 0)
                    {
                        ...
                        String dateInQuery = "UPDATE `rooms` SET checkIn  = '"+datka+"', checkOut = '"+datka+"' WHERE name='"+Default1.getText()+"'";
            ...
            {
                String querySelect = "SELECT * FROM rooms WHERE name='"+Default1.getText()+"'";
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (user.getIdRoom() != null) {
            try {
                ...
                ResultSet resultRoom = preparedRoom.executeQuery();
                resultRoom.next();
                if (resultRoom.getString(6).equals(Default1.getText()))
                buttonCheck1.setText("Check Out");
    ...
    public void AddDay()
    {
        ...
        try {
            ...
            String dateInQuery = "UPDATE `rooms` SET checkOut = '"+datka+"' WHERE name='"+Default1.getText()+"'";
            PreparedStatement prepInDate = connectDB.prepareStatement(dateInQuery);
            prepInDate.executeUpdate();
