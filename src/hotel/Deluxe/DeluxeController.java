...
public class DeluxeController implements Initializable {
    ...
    public void checkInRoom() {
        ...
        try {
            ...
            preparedRoom.setString(1, Deluxe1.getText());
            ...
            if (buttonCheck1.getText().equals("Check in") && user.getMoney() > 0) {
                if (user.getIdRoom() == null && parseInt(resultRoom.getString(5)) < 1) {
                    ...
                    if (users == 0)
                    {
                        ...
                        String dateInQuery = "UPDATE `rooms` SET checkIn  = '"+datka+"', checkOut = '"+datka+"' WHERE name='"+Deluxe1.getText()+"'";
                    ...
                    guestsIn.setText(users + "/1");
                    buttonCheck1.setText("Check Out");

                }
            }
            else if (user.getIdRoom().equals(resultRoom.getString(1)))
            {
                String querySelect = "SELECT * FROM rooms WHERE name='"+Deluxe1.getText()+"'";
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (user.getIdRoom() != null) {
            try {
                ...
                ResultSet resultRoom = preparedRoom.executeQuery();
                resultRoom.next();
                if (resultRoom.getString(6).equals(Deluxe1.getText()))
                buttonCheck1.setText("Check Out");
    ...
    public void AddDay()
    {
        ...
        try {
            ...
            String dateInQuery = "UPDATE `rooms` SET checkOut = '"+datka+"' WHERE name='"+Deluxe1.getText()+"'";
            PreparedStatement prepInDate = connectDB.prepareStatement(dateInQuery);
            prepInDate.executeUpdate();
